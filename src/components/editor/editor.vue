...
export default {
    ...
    methods: {
        insertScriptTag() {
            ...
            let serviceScriptTag = document.getElementById('serviceScriptTag');
            let s = null;
            ...
            if (editorScriptTag === null) {
                ...
                serviceScriptTag.type = 'text/javascript';
                serviceScriptTag.src = this.ueditorPath + 'neditor.service.js';
                serviceScriptTag.id = 'serviceScriptTag';
            ...
            if (configScriptTag.loaded) {
                ...
                configScriptTag.addEventListener('load', () => {
                    ...
                    if (this.scriptTagStatus === 2) s.appendChild(serviceScriptTag);
                    this.initEditor();
                });
            }
            ...
            if (serviceScriptTag.loaded) {
                this.scriptTagStatus++;
            } else {
                serviceScriptTag.addEventListener('load', () => {
                    this.scriptTagStatus++;
                    serviceScriptTag.loaded = true;
                    this.initEditor();
                });
            }
            this.initEditor();
