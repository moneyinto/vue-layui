<template>
    <Card>
        <div class="layui-row layui-col-space10 site-doc-icon">
            <div class="layui-col-xs6 layui-col-sm3 layui-col-md2 layui-col-lg icon-box">
...
.site-doc-anim .icon-box {
    height: auto;
}

.site-doc-icon .icon-box .layui-icon {
    display: inline-block;
    font-size: 36px;
}

.site-doc-icon .icon-box .doc-icon-name,
.site-doc-icon .icon-box .doc-icon-code {
    color: #c2c2c2;
}

.site-doc-icon .icon-box .doc-icon-fontclass {
    height: 40px;
    line-height: 20px;
    padding: 0 5px;
    font-size: 13px;
